...
//            'url' => env('DATABASE_URL'),
        ...
        'sigrh' => [
            'driver'        => 'oracle',
            'tns'           => env('ORACLE_SIGRH_TNS', ''),
            'host'          => env('ORACLE_SIGRH_HOST', ''),
            'port'          => env('ORACLE_SIGRH_PORT', '1521'),
            'database'      => env('ORACLE_SIGRH_DB', ''),
            'username'      => env('ORACLE_SIGRH_USER', ''),
            'password'      => env('ORACLE_SIGRH_PASS', ''),
            'charset'       => env('ORACLE_SIGRH_CHARSET', 'AL32UTF8'),
            'prefix'        => env('ORACLE_SIGRH_PREFIX', ''),
            'prefix_schema' => env('ORACLE_SIGRH_SCHEMA_PREFIX', ''),
        ],
