...
@section('content')
    <div class="portlet light bordered">
        ...
        <div class="status-card">
            <div id="statusDisplay" class="status-container">
                ...
                <div class="status-info">
                    <p id="statusDescription">Descrição do status aparecerá aqui.</p>
                </div>
            </div>
        </div>
        ...
        <div class="notifications-container">
            <div class="error">
                <svg class="error-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-3-9h6a1 1 0 010 2H7a1 1 0 010-2z" clip-rule="evenodd"></path>
                </svg>
                <div class="flex">
                    <div class="error-prompt-wrap">
                        <h3 class="bold error-title">Sistema: <span class="error-level uppercase">{{$system}}</span></h3>
                        <div class="error-details">
                            <ul>
                                <li><strong class="bold uppercase">Host:</strong> {{$hostname}}</li>
                        ...
                        <div class="error-prompt-message bold caption-subject">
                            <h4 id="mensagem" class="bold" style="color: #3a3a3a">{{$mensagemErro}}</h4>
            ...
            <div class="error-prompt-message bold caption-subject">
                <div class="card-exception">
                    ...
                    <span class="card-title">trecho do código com erro</span>
                    <p class="card-description">visualização do código envolvido na exceção.</p>
                    <span class="card-tag">log</span>
                    <span class="card-tag">trace</span>

                    <div class="code-editor">
<pre><code>
@foreach ($linePreview as $line => $code)
{{ str_pad($line, 4, ' ', STR_PAD_LEFT) }} {!! e(stripslashes($code)) !!}
@endforeach
</code></pre>
                    </div>
                </div>
...
@section('js')
    <script>
        ...
        // Funcionalidade de expandir/encurtar mensagem
