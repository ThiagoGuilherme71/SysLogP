            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> lista de objetos 2 </span>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sistema-table">
                        <thead>
                            ...
                            <tbody>
                                <tr class="odd gradeX">
                                    <td> 1 </td>
                                    <td> Dr. Sheldon Lee Cooper </td>
                                    <td>
                                      <div>
                                        <a href="{{ route('secao_2.formulario2') }}" id="servico" <button type="button" class="btn btn-warning"> Editar </button></a>
                                ...
                                <tr class="odd gradeX">
                                    <td> 2 </td>
                                    <td> Leonard Leakey Hofstadter </td>
                                    <td>
                                      <div>
                                        <a href="{{ route('secao_2.formulario2') }}" id="servico" <button type="button" class="btn btn-warning"> Editar </button></a>
                                        <a onclick="confirmacaoExcluir('$sistema->id')" class="btn btn-danger" role="button">Excluir</a>
...
@section('js')
    <script>
        function novo(){
            var rota = "{{ route('secao_2.formulario2') }}";
